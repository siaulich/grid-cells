...
def generate_random_walk(
    ...
    Args:
        ...
        speed_update_interval: Time interval for updating speed in seconds. Default: 0.5e-1.
    ...
    speed_update_steps = int(speed_update_interval / dt)
