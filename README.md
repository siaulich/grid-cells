...
## Installation
To run the simulations, you will need to have Python installed on your system. You can install the required dependencies using pip:
```bash
...
The models can be run with the provided jupyter notebooks.